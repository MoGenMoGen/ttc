...
<template>
	<view class="detailContainer">
		...
		<view class="detailContent" style="margin-top: 20rpx;"v-if="currentIndex==2||currentIndex==3">
			...
			<view class="bodyList" style="border-bottom: 0;" v-if="currentIndex==2">
				<view class="bodyListTitle">
					上报人
				</view>
				<view class="bodyListContent">
			...
			<view class="bodyList" v-if="currentIndex==3" style="border-bottom: 0;">
				<view class="bodyListTitle">
					确认时间
				</view>
				<view class="bodyListContent">
		...
		<view class="contentText" v-if="currentIndex==1">
			<view class="TextTitle">
				确认
			</view>
			<textarea value="" placeholder="多行输入"  class="textareaInTwo" placeholder-class="placeholderIn"/>
		</view>
		<view class="photograpBox" v-if="currentIndex==1">
